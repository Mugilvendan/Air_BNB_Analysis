...
file_path = '../airbnb/airbnb_data.csv'
df = pd.read_csv(file_path)

#home page
if selected == "Home":
    col1,col2 = st.columns(2,gap= 'small')
    col1.markdown("##### :orange[Domain] : Travel Industry, Property Management and Tourism")
    col1.markdown("##### :orange[Technologies used] : Python, Pandas, Plotly, Streamlit, MongoDB")
    col1.markdown("##### :orange[Overview] : To analyze Airbnb data using MongoDB Atlas, perform data cleaning and preparation, develop interactive visualizations ")
